"""
Name(s): Rachel Zheng
Name of Project: You Are Looking For A Child
"""
import os
...
def location(): # COMPLETE
    os.system('clear')
    print("LOCATION:")
    print("\nEnter 1 for the main corridor, enter 2 for the reception area, enter 3 for the library, enter 4 for the mess hall, enter 5 to see Colonel Mustang in his office.")
    loc = input("\nEnter your choice: ")
    while loc != "1" and loc != "2" and loc != "3" and loc != "4" and loc != "5":
        loc = input("\nInvalid answer. Enter your choice: ")
    if loc == "1":
        corridor()
    elif loc == "2":
...
def office():
  os.system('clear')
  print("LOCATION: COLONEL MUSTANG'S OFFICE\n")
  print('MUSTANG: "Ah, sergeant, I was just going to send someone to find you. I changed my mind, turns out I no longer need to see Elric. Also, he should be in the restricted area of the library, which you', "aren't actually able to access.", 'Apologies for sending you on a wild goose chase."')
  print("\nCONGRATULATIONS, YOU WIN THE GAME!!!")
  officechoice = input("\nEnter 1 to restart: ")
  while officechoice != "1":
    officechoice = input("\nInvalid answer. Enter 1 to restart: ")
  if officechoice == "1":
    start()
...
def fuery(surname): # COMPLETE EXCEPT FOR POSSIBLE EDITS TO FIT HAVOC+BREDA --> SHESKA
  os.system('clear')
  print("LOCATION: LIBRARY\n")
